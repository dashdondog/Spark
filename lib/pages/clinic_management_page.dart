...
class _ClinicManagementPageState extends State<ClinicManagementPage> {
  ...
  String? _mainImagePath; // local file path after picking
  ...
  Future<void> _pickMainImage(ImageSource source) async {
    try {
      ...
      if (image != null && mounted) {
        setState(() => _mainImagePath = image.path);
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Гол зураг амжилттай солигдлоо'),
            ...
            child: ClipRRect(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  else if (clinic.imageUrl.isNotEmpty)
                    CachedNetworkImage(
