    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(child: _buildSectionHeader('Шилдэг клиникүүд', onSeeAll: () {
            Navigator.push(context, MaterialPageRoute(builder: (_) => const _AllClinicsPage()));
          })),
          SliverToBoxAdapter(child: _buildTopDoctors()),
          SliverToBoxAdapter(child: _buildSectionHeader('Ойролцоо клиникүүд', onSeeAll: () {})),
          _buildClinicList(),
...
class _MessagesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppTheme.background,
      appBar: AppBar(
          title: const Text('Мессеж'), automaticallyImplyLeading: false),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
...
class _ProfileTab extends StatelessWidget {
  ...
  void _showProfileEdit(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(builder: (_) => const _ProfileEditPage()));
  }

  void _showMyBookings(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(builder: (_) => const _MyBookingsPage()));
  }
  ...
  void _showHelp(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(builder: (_) => const _HelpPage()));
  }
